...
public abstract class Hilt_ModuleSettingsDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ModuleSettingsDialogFragment() {
    super();
  }

  Hilt_ModuleSettingsDialogFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModuleSettingsDialogFragment_GeneratedInjector) this.generatedComponent()).injectModuleSettingsDialogFragment(UnsafeCasts.<ModuleSettingsDialogFragment>unsafeCast(this));
    }
  }
