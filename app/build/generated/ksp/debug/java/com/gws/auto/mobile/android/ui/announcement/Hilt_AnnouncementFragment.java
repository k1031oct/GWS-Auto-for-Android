...
public abstract class Hilt_AnnouncementFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AnnouncementFragment() {
    super();
  }

  Hilt_AnnouncementFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnnouncementFragment_GeneratedInjector) this.generatedComponent()).injectAnnouncementFragment(UnsafeCasts.<AnnouncementFragment>unsafeCast(this));
    }
  }
