...
public abstract class Hilt_ThemeSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ThemeSettingsFragment() {
    super();
  }

  Hilt_ThemeSettingsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ThemeSettingsFragment_GeneratedInjector) this.generatedComponent()).injectThemeSettingsFragment(UnsafeCasts.<ThemeSettingsFragment>unsafeCast(this));
    }
  }
