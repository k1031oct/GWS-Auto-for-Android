...
public abstract class Hilt_AccountConnectionsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AccountConnectionsFragment() {
    super();
  }

  Hilt_AccountConnectionsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AccountConnectionsFragment_GeneratedInjector) this.generatedComponent()).injectAccountConnectionsFragment(UnsafeCasts.<AccountConnectionsFragment>unsafeCast(this));
    }
  }
