...
public abstract class Hilt_MainSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainSettingsFragment() {
    super();
  }

  Hilt_MainSettingsFragment(int p0) {
    super(p0);
  }
