...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull LinearLayout rootView, @NonNull TextView status,
      @NonNull TextView timestamp, @NonNull TextView workflowName) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHistoryBinding((LinearLayout) rootView, status, timestamp, workflowName);
    }
