...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.toastNotificationModuleProvider = new SwitchingProvider<>(singletonCImpl, 20);
      this.workflowRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<WorkflowRepository>(singletonCImpl, 21));
      ...
      this.scheduleRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 22);
    ...
    private void initialize2(final ApplicationContextModule applicationContextModuleParam) {
      this.tagRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<TagRepository>(singletonCImpl, 23));
      this.searchHistoryRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SearchHistoryRepository>(singletonCImpl, 24));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 20: // com.gws.auto.mobile.android.domain.engine.modules.ToastNotificationModule
          ...
          case 21: // com.gws.auto.mobile.android.data.repository.WorkflowRepository
          return (T) new WorkflowRepository(singletonCImpl.workflowDao());

          case 22: // com.gws.auto.mobile.android.data.repository.ScheduleRepositoryImpl
          ...
          case 23: // com.gws.auto.mobile.android.data.repository.TagRepository
          return (T) new TagRepository(singletonCImpl.tagDao());

          case 24: // com.gws.auto.mobile.android.data.repository.SearchHistoryRepository
