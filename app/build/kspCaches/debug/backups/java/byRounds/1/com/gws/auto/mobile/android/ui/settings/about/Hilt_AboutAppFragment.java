...
public abstract class Hilt_AboutAppFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AboutAppFragment() {
    super();
  }

  Hilt_AboutAppFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AboutAppFragment_GeneratedInjector) this.generatedComponent()).injectAboutAppFragment(UnsafeCasts.<AboutAppFragment>unsafeCast(this));
    }
  }
