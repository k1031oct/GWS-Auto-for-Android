...
public abstract class Hilt_WorkflowFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WorkflowFragment() {
    super();
  }

  Hilt_WorkflowFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkflowFragment_GeneratedInjector) this.generatedComponent()).injectWorkflowFragment(UnsafeCasts.<WorkflowFragment>unsafeCast(this));
    }
  }
