...
public abstract class Hilt_WeekStartFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeekStartFragment() {
    super();
  }

  Hilt_WeekStartFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeekStartFragment_GeneratedInjector) this.generatedComponent()).injectWeekStartFragment(UnsafeCasts.<WeekStartFragment>unsafeCast(this));
    }
  }
