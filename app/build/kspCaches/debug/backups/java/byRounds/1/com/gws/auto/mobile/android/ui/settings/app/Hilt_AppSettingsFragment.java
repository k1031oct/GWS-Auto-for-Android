...
public abstract class Hilt_AppSettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppSettingsFragment() {
    super();
  }

  Hilt_AppSettingsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppSettingsFragment_GeneratedInjector) this.generatedComponent()).injectAppSettingsFragment(UnsafeCasts.<AppSettingsFragment>unsafeCast(this));
    }
  }
