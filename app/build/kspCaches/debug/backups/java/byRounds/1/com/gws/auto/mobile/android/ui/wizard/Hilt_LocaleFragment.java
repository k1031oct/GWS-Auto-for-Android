...
public abstract class Hilt_LocaleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LocaleFragment_GeneratedInjector) this.generatedComponent()).injectLocaleFragment(UnsafeCasts.<LocaleFragment>unsafeCast(this));
    }
  }
