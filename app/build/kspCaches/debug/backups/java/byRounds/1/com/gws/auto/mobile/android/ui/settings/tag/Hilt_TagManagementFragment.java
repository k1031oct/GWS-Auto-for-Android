...
public abstract class Hilt_TagManagementFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TagManagementFragment() {
    super();
  }

  Hilt_TagManagementFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TagManagementFragment_GeneratedInjector) this.generatedComponent()).injectTagManagementFragment(UnsafeCasts.<TagManagementFragment>unsafeCast(this));
    }
  }
